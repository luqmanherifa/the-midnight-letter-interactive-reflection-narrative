            ...
            >
              <div className="space-y-3">
                <div className="text-center">
                  <p className="text-xs text-stone-400 mb-1">Midnight Letter</p>
...
export function TitleScreen() {
  ...
  return (
    <div className="text-center">
      ...
      >
        <TypewriterText text={title.title} delay={0} speed={0.05} />
      </h1>
      <div
          ...
          return (
            ...
            >
              <TypewriterText
                ...
                speed={0.03}
                onComplete={() => {
                  if (isLastLine) setCompletedSubtitle(true);
                }}
              />
            </p>
          );
        ...
        >
          ...
          <a
            ...
            className={`transition-colors ${
              theme === "dark" ? "hover:text-stone-400" : "hover:text-stone-600"
            }`}
          >
            Luqman Herifa
          </a>
    ...
    <div className="text-content">
      {lines.map((line, i) => {
        ...
        return (
          <p
            key={i}
            className={`leading-relaxed tracking-wide text-sm ${
